    ...
    implements Serializable, Runnable
{
  ...
  //Nombre de boucle restante à effectuer
  private int tour;
      ...
      throws SonException
  {
    try
    {
      ...
      //Récup�èe le format de codage du son
  ...
  {
    //Si le son n'est pas initialisé, on l'initialise
    if(this.thread == null)
    {
      this.thread = new Thread(this);
      this.thread.start();
  ...
  /**
   * Joue le son un très grand nombre de fois
   */
  public void boucle()
  {
  ...
  /**
   * Action du son, ne jamais appeler cette méthode directement, elle est public pour respecter l'implémentation de Runnable
   */
  public void run()
  {
    ...
    while(this.thread != null)
    {
      ...
      if(this.tour > 0)
      {
        ...
        if(this.tour < 1)
        {
          //Si on a fini de jouer, on termine
          this.terminer();
   ...
   * @param fermer <b>true</b> pour indiquer que l'on désire que le son soit détruit après la dernière fois qu'il joue
   */
   ...
   * @param microseconde Place à laquelle on désire commencer le son
   */
   ...
   * @param duree Place à laquelle on désire commencer le son
   */
   ...
   * @return <b>true</b> si le son est entrain d'etre joué
   */
  ...
  /**
   * Indique à tous les écouteurs d'évènements son, que le son est terminé
   */
  ...
  /**
   * Indique à tous les écouteurs d'évènements son, que le son a avancé
   */
